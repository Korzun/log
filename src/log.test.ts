  ...
  describe('prefix', () => {
    describe('`true`', () => {
      test('outputs messages with prefixes', () => {
        ...
        expect(infoSpy).toHaveBeenCalledWith('[OKAY]', 'bar');
        expect(infoSpy).toHaveBeenCalledWith('[STRT]', 'baz');
        expect(warnSpy).toHaveBeenCalledWith('[WARN]', 'foo');
        expect(errorSpy).toHaveBeenCalledWith('[ERROR]', 'foo');
        expect(errorSpy).toHaveBeenCalledWith('[FAIL]', 'bar');
      });
    });
    describe('`false`', () => {
      test('outputs messages without prefixes', () => {
        ...
        expect(infoSpy).toHaveBeenCalledWith('baz');
